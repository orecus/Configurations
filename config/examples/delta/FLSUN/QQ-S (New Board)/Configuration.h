...
#define PID_FUNCTIONAL_RANGE 25 // orecus If the temperature difference between the target temperature and the actual temperature \
...
#define DEFAULT_Kp 24.0 //orecus AndersS = 28.16
#define DEFAULT_Ki 0.88 //orecus AndersS = 3.38
#define DEFAULT_Kd 80.0 //orecus AndersS = 58.69
